...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    fetchMessage() {
      var $async$goto = 0,
        ...
        $async$returnValue;
      var $async$fetchMessage = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = 3;
              return A._asyncAwait(A.Future_Future$delayed(new A.Duration(1000000), type$.dynamic), $async$fetchMessage);
            case 3:
      ...
      return A._asyncStartSync($async$fetchMessage, $async$completer);
    },
    main() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        t1, list, map, element, $async$temp1;
      var $async$main = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              element = A._asJSObjectQ(A._asJSObject(init.G.document).querySelector("#output"));
              if (element == null)
                element = A._asJSObject(element);
              element.textContent = "Hello Dart ";
              A.print("Hello Dart");
              t1 = type$._ElementEventStreamImpl_JSObject;
              A._EventStreamSubscription$(element, "click", t1._eval$1("~(1)?")._as(new A.main_closure()), false, t1._precomputed1);
              list = A._setArrayType([1, 2, 3], type$.JSArray_int);
              t1 = type$.String;
              map = A.LinkedHashMap_LinkedHashMap$_literal(["name", "dart", "lang", "web"], t1, t1);
              B.JSArray_methods.add$1(list, 4);
              map.$indexSet(0, "age", "10");
              A.print(null);
              $async$temp1 = A;
              $async$goto = 2;
              return A._asyncAwait(A.fetchMessage(), $async$main);
            case 2:
              // returning from await.
              $async$temp1.print($async$result);
              A.print(new A.main_closure0().call$1(5));
              B.JSArray_methods.forEach$1(list, new A.main_closure1());
              // implicit return
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, A.SafeToStringHook, J.ArrayIterator, A.Error, A.ListIterator, A.FixedLengthListMixin, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A.ExceptionAndStackTrace, A._StackTrace, A.Closure, A.MapBase, A.LinkedHashMapCell, A.Rti, A._FunctionParameters, A._Type, A._TimerImpl, A._AsyncAwaitCompleter, A.AsyncError, A._FutureListener, A._Future, A._AsyncCallbackEntry, A.Stream, A._StreamIterator, A._Zone, A.ListBase, A.Duration, A.OutOfMemoryError, A.StackOverflowError, A._Exception, A.Null, A._StringStackTrace, A.StringBuffer, A.EventStreamProvider, A._EventStreamSubscription]);
    ...
    _inheritMany(A.Closure, [A.Closure0Args, A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._awaitOnObject_closure, A._Future__propagateToListeners_handleWhenCompleteCallback_closure, A.Stream_length_closure, A._RootZone_bindUnaryCallbackGuarded_closure, A._EventStreamSubscription_closure, A.main_closure, A.main_closure0, A.main_closure1]);
