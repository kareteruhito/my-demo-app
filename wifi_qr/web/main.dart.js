...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      var t1, result,
        btn = A._asJSObjectQ(A._asJSObject(init.G.document).querySelector("#btn"));
      if (btn != null) {
